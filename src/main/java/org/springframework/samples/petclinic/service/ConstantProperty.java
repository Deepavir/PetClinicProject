...
public class ConstantProperty {
	...
	public static String getMailBodyFirstPart(String name, LocalDate localDate, String petname, String ownername) {
		...
		sb.append("<html>")
         .append("<body>").append("<h2> Dear ").append(ownername).append(",</h2>")
				...
				.append(localDate).append(" of your pet ").append(petname).append("<br>")
